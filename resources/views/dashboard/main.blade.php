      ...
      <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3"> 
          ...
          <div class="card-body"> 
            <table class=" table table-striped  align-middle mb-0 bg-white">
                                ...
                                <tbody>
                                @foreach($projectenpause as $key => $project)
                                     <tr data-entry-id="{{ $project->id }}">
                                       ...
                                       <td>
                                          ...
                                          <td>
                                            ...
                                            <td>
                                            <span class="badge badge-secondary rounded-pill d-inline"  > {{ $project->etatprojet ?? '' }}</span >
   ...
   <div class="col">
    ...
    <div class="card-header badge-success">
       ...
       <table class=" table table-striped  align-middle mb-0 bg-white">
                                ...
                                <tbody>
                                @foreach($projectdone as $key => $project)
                                     <tr data-entry-id="{{ $project->id }}">
                                       ...
                                       <td>
                                          ...
                                          <td>
                                            ...
                                            <td>
                                            <span class="badge badge-success rounded-pill d-inline"  > {{ $project->etatprojet ?? '' }}</span >
